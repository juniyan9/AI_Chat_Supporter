...
import RoomModal from './RoomModal'; // 모달 컴포넌트 임포트
...
export default function ChatListPage() {
    ...
    const SERVER_URL = 'http://192.168.0.154:5001'; // 서버 URL 하드코딩
    ...
    const handleSearchChange = (e) => {
        ...
        setFilteredRoom(rooms.filter(room => room.name.toLowerCase().includes(query)));
    };
